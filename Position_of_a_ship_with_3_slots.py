...
def Position_of_a_ship_with_3_slots():
    ...
    starting_cell = '10-8'.split('-')  # Проверка
    ...
    if direction == 'horizontal' and field[starting_cell_row].count(0) == 10:
    ...
    elif direction == 'vertical' and field[starting_cell_column].count(0) == 10:   # РАЗОБРАТЬСЯ С КОЛЛИЧЕСТВОМ НУЛЕЙ В КОЛОНКАХ!!!
