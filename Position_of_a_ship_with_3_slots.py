...
def Position_of_a_ship_with_3_slots():
    ...
    while count_of_ship_3 < 2:
        ...
        if direction == 'horizontal':
            ...
            elif field[starting_cell_row].count(0) == 3 and field[starting_cell_row][1] == 0 and field[starting_cell_row][3] == 0:
                starting_cell_column = 1
                Ship_3_horizontal()

            elif field[starting_cell_row].count(0) == 3 and field[starting_cell_row][7] == 0 and field[starting_cell_row][10] == 0:
                starting_cell_column = 7
                Ship_3_horizontal()

            elif field[starting_cell_row].count(0) == 7 and (0 not in field[starting_cell_row][1:4] or
                                                             0 not in field[starting_cell_row][2:5] or
                                                             0 not in field[starting_cell_row][3:6] 
            ):
                pass
